...
* Что хотел создатель:
  ...
  * Хотел создать новый язык, в котором парадигма функционального программирования сбалансирована принципами императивного программирования.
...
!SLIDE left
# У Ruby немало минусов
* Высокии порог вхождения
* Много магии на первый взгляд
* Кол-во вакансий для Ruby меньше чем для Python, PHP, Java/C#
* Низкая(относительно Java) скорость работы (плата за гибкость)
* Высокое потребление памяти
* Global interpreter lock, паралельный код - миф в ruby мире
